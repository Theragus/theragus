...
Evening:  build a new spaghetti base, on purpose, in Factorio
...
- 🔧 **Automation as a personality trait.** If I do it twice, it becomes a module. See [FabricTools](https://github.com/Theragus/FabricTools) — ~211 cmdlets so you never have to click through the Fabric portal again.
- 🤖 **Bangboo-driven development.** [mcp-nomad](https://github.com/Theragus/mcp-nomad) and friends: small helpers that do the boring part while I take credit.
